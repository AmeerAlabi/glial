          ...
          <motion.div
            ...
            <div className="text-[#e0e0e0] space-y-4 mb-8">
              <p>
                ...
                <span className="text-[#47b8a6] font-medium">
                  Cranioguard Mission
                </span>
                , where we spoke to over{" "}
                <span className="text-[#47b8a6] font-medium">
                  30 motorcycle riders
                </span>{" "}
                and market traders about the importance of helmets and road
                safety, and our{" "}
                <span className="text-[#47b8a6] font-medium">
                  Medical Outreach to Secondary Schools
                </span>
                , we actively engage with communities to spread knowledge.
              </p>

              <p>
                In collaboration with{" "}
                <span className="text-[#47b8a6] font-medium">
                  Mission:Brain Ilorin
                </span>
                , we also hosted{" "}
                <span className="text-[#47b8a6] font-medium">
                  World Epilepsy Day Outreach
                </span>
                , reaching over{" "}
                <span className="text-[#47b8a6] font-medium">
                  1,000 women and mothers
                </span>{" "}
                across six locations, dispelling myths about epilepsy and
                promoting better seizure management practices.
              </p>

              <p>
                We are committed to providing resources that support the
                prevention of{" "}
                <span className="text-[#47b8a6] font-medium">TBIs</span> and
                ensuring better outcomes for individuals through early
