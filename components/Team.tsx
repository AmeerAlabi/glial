      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            raising awareness about traumatic brain injuries and providing
            ...
            <motion.div
              ...
              <div className="relative overflow-hidden rounded-xl shadow-lg bg-white h-full flex flex-col">
                ...
                <div className="p-6 text-center flex-grow flex flex-col">
                  <h3 className="text-xl font-bold text-[#17162c] mb-1">
                    {member.name}
                  </h3>
                  <p className="text-[#47b8a6] font-medium text-sm mb-4">
                    {member.role}
                  </p>
