    ...
    <div id="about" className="bg-[#f8f8f8]">
      ...
      <motion.div
        ...
        <div className="flex items-center gap-2 mb-6 md:mb-8">
          ...
          <h2 className="text-lg md:text-xl font-bold text-[#17162c]">
            Know About Us
          </h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-10">
          ...
          <p className="w-full lg:w-1/2 text-sm md:text-base text-[#17162c] leading-relaxed">
            We combine extensive research with hands-on approaches to improve
            public understanding and reduce stigma around brain injuries.
            Through impactful events, such as educating motorcycle riders about
            helmet safety or promoting epilepsy awareness, we actively engage
            communities to spread knowledge. Join us to make a lasting impact in
            the fight against TBIs.
          </p>
        </div>
      </motion.div>
