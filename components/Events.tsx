...
import cranioguardImage1 from "@/public/Assets/Images/ev3.jpg";
import cranioguardImage2 from "@/public/Assets/Images/ev1.jpg";
...
const Events = () => {
  ...
  const [hoveredEvent, setHoveredEvent] = useState<number | null>(0);
  ...
  const events = [
    {
      ...
      cta: "Learn More",
      twitterLink:
        "https://www.instagram.com/reel/C2VJqmdtze4/?igsh=MWI3OGI5a3F3ZWJ5NA==",
    ...
    <div className="py-20 bg-gradient-to-b from-white to-gray-50" ref={ref}>
      <div className="mx-auto w-11/12 max-w-6xl">
        <motion.div
          ...
          />
          <motion.h2
            className="text-3xl md:text-4xl font-bold text-[#17162c] text-center"
          ...
          <motion.p
            ...
            variants={itemVariants}>
            Engaging with communities to raise awareness and provide education
            about traumatic brain injuries and safety practices.
          </motion.p>
        </motion.div>
            ...
            <motion.div
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-1/2 p-8 flex flex-col justify-between">
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold mb-4 text-[#17162c]">
                      {event.title}
                    </h3>
