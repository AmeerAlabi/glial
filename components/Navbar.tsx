...
const Navbar = () => {
  ...
  return (
    <div className="relative px-[20px] md:shadow-0 shadow-lg lg:px-[100px] w-full h-[80px] flex justify-between items-center bg-white">
      {/* Logo */}
      <Image src={logo} alt="Logo" className="w-[125px] h-[45px]" />

      {/* Desktop Menu */}
      <div className="hidden lg:flex flex-row justify-center items-center gap-[30px]">
        <Link
          to="/"
          className="text-[16px] font-medium text-[#17162c] cursor-pointer">
          Home
        </Link>
        <Link
          to="/about"
      ...
      {/* Donate Button */}
      <div
        className="hidden lg:flex cursor-pointer w-[115px] h-[43px] rounded-[7px] bg-[#17162c] font-[500] text-white justify-center items-center"
      ...
      {/* Mobile Menu Icon */}
      <div
        className="lg:hidden cursor-pointer text-[#17162c]"
        onClick={toggleMenu}>
