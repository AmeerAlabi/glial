...
const Hero = () => {
  ...
  return (
    <div
      ref={ref}
      className="relative bg-[url('./Assets/Images/mubaraq.jpg')] bg-center overflow-hidden bg-clip-border bg-cover    min-h-screen w-full z-40 flex items-center">
      <div className="absolute inset-0 bg-gradient-to-b from-[#17162c]/40 to-[#47b8a6]/40 bg-blend-overlay">
