        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              out to us. We'll get back to you as soon as possible.
            </p>
          </motion.div>
                ...
                <div className="md:col-span-2 bg-[#17162c] p-8 text-white">
                  <motion.div variants={itemVariants} className="mb-8">
                    ...
                    <p className="text-white/70">
                      Reach out to us through the form or via our contact
                      details below.
                    </p>
                  </motion.div>
                ...
                <div className="md:col-span-3 p-8">
                  {isSubmitted ? (
                    <motion.div
                      ...
                      <h3 className="text-xl font-bold text-[#17162c] mb-2">
                        Thank You!
                      </h3>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <motion.div className="mb-6" variants={itemVariants}>
                        <label
                          htmlFor="name"
                          className="block text-[#17162c] text-sm font-medium mb-2">
                          Name
                        </label>
